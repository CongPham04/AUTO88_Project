// src/pages/NotFoundPage.tsx (Đã sửa lỗi hover)
    ...
    <>
      ...
      <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="tracking-widest mt-4">
          ...
          <span className="text-gray-500 text-xl">Xin lỗi, chúng tôi không thể tìm thấy trang bạn yêu cầu!</span>
        </div>
